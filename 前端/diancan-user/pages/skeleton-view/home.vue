			...
			<view class="skeleton-home-right">
				<view class="skeleton-home-root" v-for="(item,index) in home_right" :key="index">
					...
					<view class="skeleton-home-position">
						<view class="skeleton-position-item">{{item}}</view>
						<view class="skeleton-position-item">{{item}}</view>
						<view class="skeleton-position-item">{{item}}</view>
					</view>
...
.skeleton-home-position .skeleton-position-item{
	width: 100rpx;
	height: 40rpx;
	border-radius: 7rpx;
	background-color: #f3f3f3;
}
.skeleton-home-position .skeleton-position-item:nth-child(1){
	margin-bottom: 10rpx;
}
.skeleton-home-position .skeleton-position-item:nth-child(3){
	position: absolute;
	bottom: 0;
}
